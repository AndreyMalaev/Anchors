...
extension PreviewNewsView {
    ...
    fileprivate func setupDateLabel() {
        ...
        self.newsDateLabel.backgroundColor = .red
    ...
    fileprivate func seputTitleNewsLabel() {
        ...
        self.newsTitleLabel.backgroundColor = .red
    ...
    fileprivate func setupTitleSeparator() {
        ...
        self.newsTitleSeparator.alpha = 0.3
    ...
    fileprivate func setupAnnounceLabel() {
        ...
        self.newsAnnounceLabel.backgroundColor = .red
        self.addSubview(self.newsAnnounceLabel)
        
        self.newsAnnounceLabel.translatesAutoresizingMaskIntoConstraints = false
        self.newsAnnounceLabel.topAnchor.constraint(equalTo: self.newsTitleSeparator.bottomAnchor, constant: +10).isActive = true
